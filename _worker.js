...
const serviceName = "yopi4"; // Ganti dengan nama workers kalian
const apiKey = "X_Ev2v_iHRB8OgkaJot-zYWD04OkLrlZQYD0Fzqk"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
